...
from deforum.utils.core_utilities import duplicate_pngs_from_folder
...
def run_rife_new_video_infer(
    ...
    # Create immutable RIFE args configuration
    args = ExternalLibraryArgs(
        ...
        interp_x_amount=interp_x_amount,
        slow_mo_enabled=slow_mo_enabled,
        slow_mo_x_amount=slow_mo_x_amount,
