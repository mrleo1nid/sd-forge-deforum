...
from scripts.deforum_helpers.general_utils import get_deforum_version, clean_gradio_path_strings
...
def load_args(args_dict_main, args, anim_args, parseq_args, loop_args, controlnet_args, wan_args, video_args, custom_settings_file, root, run_id):
    ...
    with open(custom_settings_file.name, "r") as f:
        ...
        for args_namespace in [args, anim_args, parseq_args, loop_args, controlnet_args, wan_args, video_args]:
