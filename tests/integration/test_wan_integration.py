#!/usr/bin/env python3
"""
Integration test for WAN functionality with QwenPromptExpander and movement analysis
"""
...
def test_movement_analyzer():
    ...
    try:
        from deforum.integrations.wan.utils.movement_analyzer import analyze_deforum_movement
...
def test_arguments_integration():
    ...
    try:
        from deforum.config.arguments import WanArgs
