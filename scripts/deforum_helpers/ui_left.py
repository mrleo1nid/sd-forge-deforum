...
def setup_deforum_left_side_ui():
    ...
    with gr.Blocks():
        with gr.Tabs():
            ...
            for key, value in {**tab_run_params, **tab_keyframes_params, **tab_distribution_params, **tab_prompts_params, **tab_shakify_params, **tab_depth_params, **tab_init_params, **controlnet_dict, **tab_freeu_params, **tab_kohya_hrfix_params, **tab_wan_params, **tab_hybrid_params, **tab_output_params}.items():
                locals()[key] = value
